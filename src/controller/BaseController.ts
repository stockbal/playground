...
/**
 * @namespace com.devepos.apps.playground.controller.Base
 */
export default class BaseController extends Controller {
    // protected router: Router; // TODO: needed for routing
    ...
    onNavBack(): void {
        ...
        if (previousHash !== undefined) {
            ...
            // this.router.navTo("main", {}, true); // TODO: needed for routing
        }
    }
}
